...
y.bifrost = ['C:\Users\etber\OneDrive - Massachusetts Institute of Technology\Documents\CCS\5. MRIOs\2. Input Vektor\Sensitivity_Unit'];
wd.hd_sa = ['C:\Users\etber\OneDrive - Massachusetts Institute of Technology\Documents\CCS\5. MRIOs\'];

Y_cty = importdata(fullfile(y.bifrost,'Input_Vektor_Unit_USD.csv'));
...
%%
    ...
    for i = 1:length(stressor)
        ...
        block_size = 240;
        num_blocks = length(Q) / block_size;
        ...
        %Q_d = diag(Q);
        %A_Q_2 = Q_d * A; %Approximatly 300 times longer ...
        ...
        % Write to CSV
        savePath = fullfile(wd.hd_sa,'\4. Output\sensitivity_unit\', [num2str(year) '_' stressor{i} '_T_BIFROST_Unit_Rank1_' num2str(gloria_vrs) '_country.csv']);
